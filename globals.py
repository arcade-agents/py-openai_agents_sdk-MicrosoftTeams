...
TOOLS = None
MCP_SERVERS = ['MicrosoftTeams']
TOOL_LIMIT = 30
MODEL = os.getenv("OPENAI_MODEL", "gpt-4o-mini")
AGENT_NAME = "MicrosoftTeams_Agent"
SYSTEM_PROMPT = """
...
"""
ENFORCE_HUMAN_CONFIRMATION = ['MicrosoftTeams_CreateChat', 'MicrosoftTeams_ReplyToChannelMessage', 'MicrosoftTeams_ReplyToChatMessage', 'MicrosoftTeams_SendMessageToChannel', 'MicrosoftTeams_SendMessageToChat']